...
protected double bonus;public CoreStaff(String fullName, String taxId, String startDate, String roleTag,
...
super(fullName, taxId, startDate, roleTag, staffCode);
this.totalHours = totalHours;this.ratePerHour = ratePerHour;
}
@Override
public double computeEarnings() {
